...
import getAttribute from '../../../src/util/get-attribute';
...
let object = {
    ...
    bar: function (param1: string = null, param2: string = null) {
...
let anyCall = function (object: any, item: any, strictVariables: boolean = true, definedTest: boolean = false) {
    return getAttribute(env, source, object, item, [], TwingTemplate.ANY_CALL, definedTest, !strictVariables);
};

let arrayCall = function (object: any, item: any, strictVariables: boolean = true, definedTest: boolean = false) {
    return getAttribute(env, source, object, item, [], TwingTemplate.ARRAY_CALL, definedTest, !strictVariables);
};

let methodCall = function (object: any, item: any, methodArguments: Array<any> = [], strictVariables: boolean = true, definedTest: boolean = false) {
    return getAttribute(env, source, object, item, methodArguments, TwingTemplate.METHOD_CALL, definedTest, !strictVariables);
};

tap.test('getAttribute', function (test: Test) {
    test.test('should support default arguments', function (test: Test) {
        let actual = getAttribute(env, source, ['foo'], 0);
    ...
    test.test('should support', function (test) {
        ...
        test.test('arrays', function (test: Test) {
        ...
        test.test('maps', function (test: Test) {
            let map = new Map([
                ['foo', 'foo'],
                ['bar', 'bar']
            ]);
        ...
        test.test('objects', function (test: Test) {
            ...
            try {
                ...
                test.equal(e.getRawMessage(), 'Neither the property "undefined" nor one of the methods undefined()", "getUndefined()", "isUndefined()" or "hasUndefined()" or "__call()" exist in class "Object".');
            }
        ...
        test.test('primitives', function (test: Test) {
            test.test('any call', function (test: Test) {
            ...
            test.test('method call', function (test: Test) {
                // isDefinedTest is true
