...
let fixturesPath = nodePath.resolve('test/tests/unit/loader/filesystem/fixtures');

let basePaths = [
    [
        fixturesPath,
        'test/tests/unit/loader/filesystem/fixtures/named_quater/named_absolute.html',
        null
    ],
    [
    ...
    [
        'test/tests/unit/loader/filesystem/fixtures',
        'test/tests/unit/loader/filesystem/fixtures/named_quater/named_absolute.html',
        process.cwd()
    ],
    [
        ...
        nodePath.join(process.cwd(), 'test/tests/unit/loader/filesystem')
    ],
    [
        'fixtures',
        'fixtures/named_quater/named_absolute.html',
        nodePath.join(process.cwd(), 'test/../test/tests/unit/loader/filesystem')
    ]
];
...
tap.test('loader filesystem', function (test) {
    ...
    test.test('security', function (test) {
        for (let securityTest of securityTests) {
            ...
            let loader = new TwingLoaderFilesystem([nodePath.resolve('test/tests/unit/loader/filesystem/fixtures')]);
