...
const {TwingLoaderRelativeFilesystem: TwingLoaderFilesystem} = require('../../../../../build/loader/relative-filesystem');
...
tap.test('loader filesystem', function (test) {
    ...
    test.test('exists', function (test) {
        let resolvePath = (path) => {
            return nodePath.resolve('test/tests/unit/loader/filesystem/fixtures', path);
        };
