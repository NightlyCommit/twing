...
const {TwingNodeBlock} = require("../../../../../../build/node/block");
...
const {TwingProfilerNodeVisitorProfiler} = require("../../../../../../build/profiler/node-visitor/profiler");
...
tap.test('profiler/node-visitor/profiler', function (test) {
    ...
    test.test('doLeaveNode', function (test) {
        ...
        test.test('when the node is of type "BLOCK"', function (test) {
            ...
            let block = new TwingNodeBlock('foo', body, 1, 1);
        ...
        test.test('when the node is of type "MACRO"', function (test) {
            let body = new TwingNodeText('foo', 1, 1);
            let macro = new TwingNodeMacro('foo', body, new TwingNode(), 1, 1);
