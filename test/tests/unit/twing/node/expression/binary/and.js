...
const TwingNodeExpressionBinaryAnd = require('../../../../../../../lib/twing/node/expression/binary/and').TwingNodeExpressionBinaryAnd;

const tap = require('tap');

tap.test('node/expression/binary/and', function (test) {
