...
const TwingNodeExpressionBinaryBitwiseXor = require('../../../../../../../lib/twing/node/expression/binary/bitwise-xor').TwingNodeExpressionBinaryBitwiseXor;

const tap = require('tap');

tap.test('node/expression/binary/bitwise-xor', function (test) {
