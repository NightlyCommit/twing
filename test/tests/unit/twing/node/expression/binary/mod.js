...
const TwingNodeExpressionBinaryMod = require('../../../../../../../lib/twing/node/expression/binary/mod').TwingNodeExpressionBinaryMod;

const tap = require('tap');

tap.test('node/expression/binary/mod', function (test) {
    test.test('constructor', function (test) {
        let left = new TwingNodeExpressionConstant(1, 1);
        let right = new TwingNodeExpressionConstant(2, 1);
        let node = new TwingNodeExpressionBinaryMod(left, right, 1);
