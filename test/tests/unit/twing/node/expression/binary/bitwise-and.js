...
const TwingNodeExpressionBinaryBitwiseAnd = require('../../../../../../../lib/twing/node/expression/binary/bitwise-and').TwingNodeExpressionBinaryBitwiseAnd;

const tap = require('tap');

tap.test('node/expression/binary/bitwise-and', function (test) {
    test.test('constructor', function (test) {
        let left = new TwingNodeExpressionConstant(1, 1);
        let right = new TwingNodeExpressionConstant(2, 1);
        let node = new TwingNodeExpressionBinaryBitwiseAnd(left, right, 1);
