...
tap.test('node/with', function (test) {
    let bodyNode = new TwingNodeExpressionName('foo', 1);
    let variablesNode = new TwingNodeExpressionConstant('bar', 1);

    test.test('constructor', function (test) {
        let node = new TwingNodeWith(bodyNode, variablesNode, false, 1);
