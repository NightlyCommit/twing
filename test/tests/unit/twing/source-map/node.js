...
tap.test('source-map/node', (test) => {
    test.test('constructor', (test) => {
        let node = new TwingSourceMapNode(TwingNodeType.TEXT, 'foo', 10, 100);

        test.equals(node.getType(), TwingNodeType.TEXT);
        test.equals(node.getSource(), 'foo');
    ...
    test.test('addChild', (test) => {
        let node = new TwingSourceMapNode(TwingNodeType.TEXT, 'foo', 0, 0);
        let child = new TwingSourceMapNode(TwingNodeType.PRINT, 'bar', 1, 1);
