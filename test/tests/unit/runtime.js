...
tap.test('Twing runtime', function (test) {
    let exports = {
        ...
        echo: './twing/output-buffer',
        flush: './twing/output-buffer',
        ...
        obEndClean: './twing/output-buffer',
        obGetClean: './twing/output-buffer',
        obGetContents: './twing/output-buffer',
        obStart: './twing/output-buffer',
