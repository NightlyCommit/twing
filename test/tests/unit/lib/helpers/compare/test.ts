import {compare} from "../../../../../../src/lib/helpers/compare";
...
let arrayEmpty = ['[]', new Map()];
let arrayNonEmpty= ['["php"]', new Map([[0, 'php']])];
let arrayNonEmpty2= ['["js"]', new Map([[0, 'js']])];
let arrayNonEmpty3= ['["php", "js"]', new Map([[0, 'php'], [1, 'js']])];
...
tape('compare', (test) => {
    test.test('should conform to PHP loose comparisons rules', (test) => {
        let rules = new Map([
            // TRUE
