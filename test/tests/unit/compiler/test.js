...
tap.test('compiler', function (test) {
    ...
    test.test('addSourceMapEnter', function(test) {
        ...
        test.same(compiler.compile(new CustomNode(1, 1)).getSource(), 'this.env.enterSourceMapBlock(1, 1, `body`, this.getSourceContext(), this.env.getSourceMapNodeConstructor(\'body\'));\n');
