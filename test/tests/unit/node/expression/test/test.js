const {TwingNodeExpressionTest} = require('../../../../../../build/node/expression/test');
const {TwingNodeExpressionConstant} = require('../../../../../../build/node/expression/constant');
const {TwingNodeExpressionTestNull} = require('../../../../../../build/node/expression/test/null');
...
tap.test('node/expression/test', function (test) {
    ...
    test.test('compile', function (test) {
        ...
        test.test('basic', function (test) {
            let expr = new TwingNodeExpressionConstant('foo', 1, 1);
            let node = new TwingNodeExpressionTestNull(expr, 'null', new TwingNode(new Map()), 1, 1);
