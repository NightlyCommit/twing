const {TwingNodeExpressionBinaryNotIn} = require('../../../../../../../build/node/expression/binary/not-in');
...
tap.test('node/expression/binary/not-in', function (test) {
    ...
    test.test('compile', function (test) {
        ...
        test.same(compiler.compile(node).getSource(), '!Runtime.isIn(1, 2)');
