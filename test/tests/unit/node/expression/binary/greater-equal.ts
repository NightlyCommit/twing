...
import {TwingNodeExpressionBinaryGreaterEqual} from "../../../../../../src/node/expression/binary/greater-equal";

const tap = require('tap');

tap.test('node/expression/binary/greater-equal', function (test: Test) {
