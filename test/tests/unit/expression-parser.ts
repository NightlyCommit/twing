...
tap.test('expression-parser', function (test: Test) {
    test.test('canOnlyAssignToNames', function (test: any) {
    ...
    test.test('arrayExpression', function (test: Test) {
        let templatesAndNodes: any = [
            // simple array
    ...
    test.test('arraySyntaxError', function (test: any) {
        let templatesAndMessages: any = [
    ...
    test.test('stringExpression', function (test: any) {
        let templatesAndNodes: any = [
    ...
    test.test('macroDefinitionDoesNotSupportNonConstantDefaultValues', function (test: any) {
        let templates = [
    ...
    test.test('macroDefinitionSupportsConstantDefaultValues', function (test: any) {
        let templates = [
