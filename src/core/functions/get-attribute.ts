 ...
 * @internal
 */
export function twingFunctionGetAttribute(env: TwingEnvironment, object: any, item: any, _arguments: Array<any> = [], type: string = TwingTemplate.ANY_CALL, isDefinedTest: boolean = false, ignoreStrictCheck: boolean = false, sandboxed: boolean = false) {
    let message: string;
